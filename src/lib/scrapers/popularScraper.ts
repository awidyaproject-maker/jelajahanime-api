...
export class PopularScraper {
   ...
   */
  private static async scrapePopularWithPuppeteer(pageNum: number = 1): Promise<{query: string, results: any[], pagination: any}> {
    let browser: Browser | null = null;
    let page: Page | null = null;

    try {
      console.log(`Launching Puppeteer browser for popular anime page: ${pageNum}`);
      ...
      console.log(`Navigating to popular URL: ${popularUrl}`);
      ...
      console.log('Popular page content retrieved, length:', content.length);
